// rungpu.cu — default GPU FP32 inference, mirrors cpu/run.cpp (the finished result of
// gpu_tutorial module 06).
//
...
//
// Build:  nvcc -O3 -std=c++20 -o /tmp/rungpu gpu/default/rungpu.cu -lcublas
// Run:    /tmp/rungpu models/stories15M.bin -t 0.0 -n 128 -s 42 -i "Once upon a time"
