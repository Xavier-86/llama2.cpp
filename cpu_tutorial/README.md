...
```bash
c++ -O2 -std=c++20 -o cpu_tutorial/tools/dump_fp32 cpu_tutorial/tools/dump_fp32.cpp
c++ -O2 -std=c++20 -o cpu_tutorial/tools/dump_int8 cpu_tutorial/tools/dump_int8.cpp
./cpu_tutorial/tools/dump_fp32 cpu_tutorial models/stories15M.bin models/tokenizer.bin
./cpu_tutorial/tools/dump_int8 cpu_tutorial models/stories15M-q32.bin models/tokenizer.bin
python3 cpu_tutorial/tools/embed_data.py cpu_tutorial
```
